...
privat_key = '5119145839:AAFhy6DQP2z_utpT4gHaL_NnicsH1b6pS-A'
...
def main():
    ...
    while True:
        ...
        if update_id == update['update_id']:
            q = {'name':'QA_cloud_bot','money':'0'}
            if q[get_message_text(update).lower()] in q:
                get_message(get_chat_id(update),q[get_message_text(update).lower()])
            ...
            elif get_message_text(update).lower() == '666':
                send_message(get_chat_id(update),'Devil')
            else:
